...
class Window ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"Adding series to database", pos = wx.DefaultPosition, size = wx.Size( 800,250 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )

		self.SetSizeHints( wx.Size( -1,250 ), wx.Size( -1,-1 ) )
		...
		h_align_2.Add( self.id_box, 1, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )
		...
		vertical_align.Add( self.info_text, 0, wx.EXPAND|wx.ALL, 5 )
